...
- **Console command:** `resume-to-flock <docx-path> -o <output-dir>` (see [resume-parser README](https://github.com/sbecker11/resume-parser#usage)).
- **Module invocation:** `python3 -m resume_parser.resume_to_flock <docx-path> -o <output-dir>` (override via `RESUME_PARSER_MODULE`).
